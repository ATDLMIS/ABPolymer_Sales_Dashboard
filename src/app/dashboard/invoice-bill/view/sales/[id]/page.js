  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4 no-print">
        ...
        <button 
          onClick={handlePrint} 
          className="px-6 py-2 bg-primary1 text-white rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center gap-2 shadow-sm"
        >
      ...
      <div id="print-area" className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">

...
const Page = () => {
  ...
  const tabs = [
    { id: 'pending', label: 'Pending', component: PendingOrderList },
    { id: 'completed', label: 'Completed', component: CompleteOrderList },
    { id: 'rejected', label: 'Rejected', component: RejectedList },
    { id: 'cancelled', label: 'Cancelled', component: CencelledList }
  ]
